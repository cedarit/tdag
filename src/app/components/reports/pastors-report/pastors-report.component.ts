...
@Component({
  selector: 'app-pastors-report',
  templateUrl: './pastors-report.component.html',
  styleUrls: ['./pastors-report.component.scss'],
})
export class PastorsReportComponent  implements OnInit {
  ...
  reportUrl(sdate: string, edate: string) {
    ...
    this.pastorReportUrl = 'https://apag.digitalchurch.tech/dateWiseIncomeAll?startDate=2021-09-01&endDate=2023-09-30';
  }
